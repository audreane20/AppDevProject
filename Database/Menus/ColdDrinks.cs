        ...
        private string T(string key)
        {
            ...
            if (lang == "en")
            {
                switch (key)
                {
                    ...
                    case "MissingDrinkTitle": result = "Missing Drink"; break;
                    case "MissingSizeTitle": result = "Missing Size"; break;
                }
                return result;
            }
            ...
            if (lang == "fr")
            {
                switch (key)
                {
                    ...
                    case "MissingDrinkTitle": result = "Boisson manquante"; break;
                    case "MissingSizeTitle": result = "Taille manquante"; break;
                }
                return result;
            }
            ...
            if (lang == "es")
            {
                switch (key)
                {
                    ...
                    case "MissingDrinkTitle": result = "Bebida faltante"; break;
                    case "MissingSizeTitle": result = "Tamaño faltante"; break;
                }
                return result;
            }
